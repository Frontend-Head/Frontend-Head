...
<!-- Badges bewusst je Gruppe auf EINER Quelltextzeile: ein einzelner
     Zeilenumbruch wird von GitHub eingeloggt und ausgeloggt unterschiedlich
     gerendert (Leerzeichen vs. <br>) und stapelt die Badges sonst. -->
